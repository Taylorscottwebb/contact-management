    ...
    if matched_email:
        ...
        if email not in contacts:
            ...
            if category == "1":
                ...
                category = "Work"
                print("Contact was successfully stored as a work associate")
        ...
        if edit == "1":
            ...
            if first_name_update.isalpha() == True:
                ...
                if last_name_update.isalpha() == True:
                    ...
                    print(f"The name has been updated. Here is your new list of contacts: \n{contacts}")
            ...
            number_update = input('Enter the phone number (Example "123-456-7890") you would like the phone number changed to: ')
